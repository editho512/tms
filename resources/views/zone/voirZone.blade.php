            ...
            <div class="col-md-12 px-3">
                <div class="card card-info card-outline" style="border-color:#3490c1 !important">
                    <div class="card-header">
                        <h4 class="text-center" >Les districts de la zone</h4>
                            ...
                            <div class="col-sm-12" style="min-width:220px !important;">
                                ...
                                <p class="text-center mt-3">
                                    ...
                                    @foreach ($districts as $key =>  $district)
                                        {{ $key > 0 ? " - " . $district->district->nom : $district->district->nom }}
                                    @endforeach
                                ...
                                <div class="card card-primary">
                                    ...
                                    <div class="card-body">
                                        ...
                                        <table id="itineraire-categorie" class="mt-2 table-principale table table-bordered table-striped">
                                            ...
                                            <tbody>
                                            @if(isset($itineraires) && $itineraires->count() > 0)
                                                @foreach($itineraires as $itineraire)
                                                    <tr  >
                                                        ...
                                                        <td class="text-center">
                                                            {{strtoupper($itineraire->categorie->nom)}}
                                                        </td>
                                                        <td>
                                                            <div class="row">
                ...
                <div class="modal-body" >
                    <form  method="POST" action="{{route('zone.categorie.ajouter')}}" name="form-itineraire-ajouter" id="form-itineraire-ajouter">
                        ...
                        <div class="row mt-2">
                            ...
                            <div class="col-sm-8 ">
                                <select  autocomplete="off" name="depart"  class="form-control select-itineraire"   style="width:100% !important" placeholder="Nom des districts de départ"  autocomplete="off">
                                    @foreach ($districts as $district)
                                        <option value={{$district->district->id}}>{{$district->district->nom}}</option>
                                    @endforeach
                                </select>
                            </div>
                        ...
                        <div class="row">
                            ...
                            <div class="col-sm-8 mt-2">
                                <select  autocomplete="off" name="arrive"  class="form-control select-itineraire "   style="width:100% !important" placeholder="Nom des districts d'arrivé"  autocomplete="off">
                        ...
                        <div class="row">
                            ...
                            <div class="col-sm-8 mt-2">
                                <select  autocomplete="off" name="categorie"  class="form-control"   style="width:100% !important" placeholder="Nom des districts d'arrivé"  autocomplete="off">
    ...
    <div class="modal fade" id="modal-modifier-itineraire">
        <div class="modal-dialog">
            <div class="modal-content">
                ...
                <div class="modal-body" >
                    <form  method="POST" action="#" name="form-itineraire-modifier" id="form-itineraire-modifier">
                        ...
                        <div class="row mt-2">
                            ...
                            <div class="col-sm-8 ">
                                <select  name="depart"  class="form-control select-itineraire"   style="width:100% !important" placeholder="Nom des districts de départ"  autocomplete="off">
                                    @foreach ($districts as $district)
                                        <option value={{$district->district->id}}>{{$district->district->nom}}</option>
                                    @endforeach
                                </select>
                        ...
                        <div class="row">
                            ...
                            <div class="col-sm-8 mt-2">
                                <select  name="arrive"  class="form-control select-itineraire "   style="width:100% !important" placeholder="Nom des districts d'arrivé"  autocomplete="off">
                                    @foreach ($allDistricts as $item)
                                        <option value={{$item->id}}>{{$item->nom}}</option>
                                    @endforeach
                                </select>
                        ...
                        <div class="row">
                            ...
                            <div class="col-sm-8 mt-2">
                                <select  name="categorie"  class="form-control"   style="width:100% !important" placeholder="Nom des districts d'arrivé"  autocomplete="off">
                                    @foreach ($categories as $categorie)
                                        <option value={{$categorie->id}}>{{$categorie->nom}}</option>
                                    @endforeach
                                </select>
                ...
                <div class="modal-footer justify-content-between">
                    <button type="button" class="btn btn-default" data-dismiss="modal">Fermer</button>
                    <button type="submit" id="button-modifier-itineraire" form="form-itineraire-modifier"  class="float-right btn btn-success">Ajouter</button>
                </div>
            </div>
            <!-- /.modal-content -->
        </div>
            ...
            <div class="modal-content">
                ...
                <div class="modal-body" >
                        ...
                        <div class="row mt-2">
                            ...
                            <div class="col-sm-8 ">
                                <select  disabled name="depart"  class="form-control select-itineraire"   style="width:100% !important" placeholder="Nom des districts de départ"  autocomplete="off">
                                    @foreach ($districts as $district)
                                        <option value={{$district->district->id}}>{{$district->district->nom}}</option>
                                    @endforeach
                                </select>
                        ...
                        <div class="row">
                            ...
                            <div class="col-sm-8 mt-2">
                                <select  disabled name="arrive"  class="form-control select-itineraire "   style="width:100% !important" placeholder="Nom des districts d'arrivé"  autocomplete="off">
                                    @foreach ($allDistricts as $item)
                                        <option value={{$item->id}}>{{$item->nom}}</option>
                                    @endforeach
                                </select>
                        ...
                        <div class="row">
                            ...
                            <div class="col-sm-8 mt-2">
                                <select disabled  name="categorie"  class="form-control"   style="width:100% !important" placeholder="Nom des districts d'arrivé"  autocomplete="off">
                                    @foreach ($categories as $categorie)
                                        <option value={{$categorie->id}}>{{$categorie->nom}}</option>
                                    @endforeach
                                </select>
