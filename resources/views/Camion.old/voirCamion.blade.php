                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            ...
                                            @else
                                            <div class="@if ($trajet->etat === App\Models\Trajet::getEtat(1)) badge badge-info @elseif ($trajet->etat === App\Models\Trajet::getEtat(0)) badge badge-warning @else badge badge-success @endif">
                                                {{ $trajet->etat }}
                                            </div>
                        ...
                        <div class="col-sm-8">
                            <select name="etat" class="form-control" id="etat" onchange="checkCarburant(this, '{{ App\Models\Trajet::getEtat(2) }}')" required>
                                ...
                                <select name="etat" class="form-control" id="etat" required>
                                    <select name="etat" class="form-control" id="etat" onchange="checkCarburant(this, '{{ App\Models\Trajet::getEtat(2) }}')" required>
                                        <select name="etat" class="form-control" id="etat" onchange="checkCarburant(this, '{{ App\Models\Trajet::getEtat(2) }}')" required>
                                            >>>>>>> b0e225bfef8ce9d69a77efcae1171b92f81d5989
